...
export const MobileShipmentWizardModal: React.FC<MobileShipmentWizardModalProps> = ({
  ...
  // Hesaplamalar (Tüm tevkifat oranları desteklenir)
  ...
  const withholdingRateMap: Record<string, number> = {
    '1/10': 0.1, '2/10': 0.2, '3/10': 0.3, '4/10': 0.4, '5/10': 0.5,
    '6/10': 0.6, '7/10': 0.7, '8/10': 0.8, '9/10': 0.9, '10/10': 1.0
  };
  const withholdingAmount = vatAmount * (withholdingRateMap[formData.withholdingRate] || 0);

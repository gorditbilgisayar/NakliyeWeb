// Türkiye Cumhuriyeti 81 İl ve Tüm İlçeleri Eksiksiz Veritabanı
...
export const TURKEY_CITIES_DISTRICTS: CityDistrictMap = {
  ...
  "Kars": ["Akyaka", "Arpaçay", "Digor", "Kağızman", "Merkez", "Saraykent", "Sarıkamış", "Selim", "Susuz"],
  ...
  "ETİ BAKIR A.Ş.": ["Mazıdağı", "Murgul", "Samsun", "Küre", "Merkez", "Tesis", "Maden Sahası", "Liman"]
};

// İl ve Sevkiyat Noktaları Listesi (En başta 'ETİ BAKIR A.Ş.' yer alır)
export const CITIES_LIST = [
  "ETİ BAKIR A.Ş.",
  ...Object.keys(TURKEY_CITIES_DISTRICTS)
